...
function Card({
  ...
  useEffect(() => {
    ...
    if (descrizione.length > 75) {
      setNewDescrizione(descrizione.slice(0, 75) + "...");
    }
  }, [nomeImmagineCamera]);

  return (
    <div className=" z-40 border-[1px] border-[#7E8794] flex flex-col justify-start items-center w-[15rem] rounded-md">
      <img
